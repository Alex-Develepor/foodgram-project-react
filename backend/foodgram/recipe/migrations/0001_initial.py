    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredients', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recipe', to='recipe.ingredient', verbose_name='Связанные ингредиенты')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time_min', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, message='Минимальное время готовки 1 минута')], verbose_name='Время приготовления в минутах')),
                ...
                ('tags', models.ManyToManyField(related_name='recipes', to='recipe.Tag', verbose_name='Tag')),
            ],
            options={
                'verbose_name': 'Рецепт',
                'ordering': ('-pub_date',),
        ...
        migrations.AddField(
            ...
            name='recipe',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ingredient', to='recipe.recipe', verbose_name='В каких рецептах'),
        ),
